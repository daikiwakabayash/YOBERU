  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
        ...
        />
        <HeroCard
          icon={<RefreshCcw className="h-3 w-3 text-blue-600" />}
          iconBg="bg-blue-100"
          label="継続売上"
          topRightLabel="LTV"
        ...
        />
        <HeroCard
          icon={<UserMinus className="h-3 w-3 text-red-500" />}
          iconBg="bg-red-100"
          label="退会率"
          topRightLabel="維持率"
      ...
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
        ...
        />
        <HeroCard
          icon={<MessageSquare className="h-3 w-3 text-slate-600" />}
          iconBg="bg-slate-100"
          label="G口コミ (合計)"
        ...
        />
        <HeroCard
          icon={<MessageSquare className="h-3 w-3 text-pink-600" />}
          iconBg="bg-pink-100"
          label="H口コミ (合計)"
